...
from aplicacion.chatbot.chatbot import ModeloIA, MatrizSustentable
import time
...
matrizSustentable_bp = Blueprint("matrizSustentable", __name__, template_folder="aplicacion/templates", url_prefix="/funciones/Fase1/matrizSustentable")
