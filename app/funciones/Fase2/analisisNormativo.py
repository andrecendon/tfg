...
from models import User,  Project, Food, Prototype, DatabaseSession
...
@login_required
def inicio():
    return render_template("funciones/Fase2/analisisNormativo.html")
...
def analisisNormativoEnv():
    ...
    return render_template("funciones/Fase1/analisisNormativo.html", suplementos=respuesta, time=tiempo)